...
import (
	...
	"code-cadets-2021/homework_3/calculator/internal/infrastructure/rabbitmq/models"
)

// EventUpdateConsumer consumes received bets from the desired RabbitMQ queue.
type EventUpdateConsumer struct {
	channel Channel
	config  ConsumerConfig
}

// NewEventUpdateConsumer creates and returns a new BetReceivedConsumer.
